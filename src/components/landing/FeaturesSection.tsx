  ...
  return (
    <section id="features" className="container-section bg-gray-900">
      <div className="text-center mb-16">
        <h2 className="text-3xl md:text-4xl font-bold mb-6 bg-linear-[to_right,#a78bfa_0%,#7c3aed_100%] bg-clip-text text-transparent">
          {t("title")}
        </h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
        <div className="bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-700 hover:border-primary-600">
          ...
          <p className="text-gray-300">{t("aiContent.description")}</p>
        </div>
        ...
        <div className="bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-700 hover:border-primary-600">
          ...
          <p className="text-gray-300">{t("analytics.description")}</p>
        </div>
        ...
        <div className="bg-gray-800 p-8 rounded-2xl shadow-lg hover:shadow-xl transition-shadow border border-gray-700 hover:border-primary-600">
          ...
          <p className="text-gray-300">{t("scheduling.description")}</p>
        </div>
      </div>
    </section>
  );
