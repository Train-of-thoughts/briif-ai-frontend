...
export default function SettingsAnchorMenu({
  ...
  return (
    <div className="bg-neutral-50 dark:bg-neutral-800 rounded-lg p-4 border border-gray-200 dark:border-neutral-700 sticky top-24">
          ...
          <li key={item.id}>
            <button
              ...
              className={`flex items-center w-full text-left px-3 py-2 rounded-md transition-all ${
                activeItem === item.id
                  ? "bg-linear-[to_right,#c4b5fd_0%,#ddd6fe_100%] dark:bg-linear-[to_right,#4c1d95_0%,#6d28d9_100%] text-white font-medium shadow-md border-l-4 border-primary-300"
